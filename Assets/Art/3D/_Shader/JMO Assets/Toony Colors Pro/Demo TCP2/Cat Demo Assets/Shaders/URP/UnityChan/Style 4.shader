	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float3 __shadowColor = ( _SColor.rgb * TCP2_TEX2D_SAMPLE(_ShadowColor, _ShadowColor, input.pack0.xy).rgb );
