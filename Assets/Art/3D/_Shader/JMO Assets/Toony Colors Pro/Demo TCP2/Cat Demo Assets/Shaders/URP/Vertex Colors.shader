	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float4 __albedo = ( TCP2_TEX2D_SAMPLE(_MainTex, _MainTex, input.pack1.xy).rgba * SRGBToLinear(input.vertexColor).rgba );
