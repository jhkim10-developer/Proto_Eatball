...
/* TCP_DATA u config(ver:"2.9.12";unity:"2022.3.1f1";tmplt:"SG2_Template_URP";features:list["ENABLE_FORWARD_PLUS","UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","SPEC_LEGACY","SPECULAR","RAMP_MAIN_OTHER","RAMP_SEPARATED","OUTLINE","SKETCH","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline",RENDER_TYPE="Opaque"];shaderProperties:list[sp(name:"Albedo";imps:list[imp_ct(lct:"_BaseMap";cc:4;chan:"RGBA";avchan:"RGBA";guid:"4fd8adb8-cdfa-43b6-a47f-01d83aefa098";op:Multiply;lbl:"Albedo";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_hsv(type:FullOffset;chue:False;csat:False;cval:False;guid:"6c096715-d17d-412a-a71f-d621445240cf";op:Multiply;lbl:"Albedo";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,,,,,,,,sp(name:"Specular Color";imps:list[imp_mp_color(def:RGBA(0.5, 0.5, 0.5, 1);hdr:False;cc:3;chan:"RGB";prop:"_SpecularColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"b542a2c0-eae8-4c61-998c-9fec51ed8816";op:Multiply;lbl:"Specular Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_spref(cc:3;chan:"AAA";lsp:"Albedo";guid:"0da4cafe-3593-41a8-9305-0cafa7fbc8cb";op:Multiply;lbl:"Specular Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,sp(name:"Sketch Texture";imps:list[imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:True;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"black";locked_uv:False;uv:4;cc:3;chan:"AAA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:True;uv_type:ScreenSpace;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_SketchTexture";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"e810afd8-a6f9-48fb-867f-f5af2189f20c";op:Multiply;lbl:"Sketch Texture";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Sketch Color";imps:list[imp_mp_color(def:RGBA(0, 0, 0, 1);hdr:False;cc:3;chan:"RGB";prop:"_SketchColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"1eb19894-6c44-4806-b5fd-47a34f2b073a";op:Multiply;lbl:"Sketch Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Sketch Threshold Scale";imps:list[imp_constant(type:float;fprc:float;fv:1.5;f2v:(1, 1);f3v:(1, 1, 1);f4v:(1, 1, 1, 1);cv:RGBA(1, 1, 1, 1);guid:"4b9c16f5-3ae5-4c4f-8522-55720ac66917";op:Multiply;lbl:"Sketch Threshold Scale";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),sp(name:"Outline Width";imps:list[imp_mp_range(def:1;min:0.1;max:4;prop:"_OutlineWidth";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"abacf6f2-0ae4-4c91-ab25-60853ce685e0";op:Multiply;lbl:"Width";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_vcolors(cc:1;chan:"R";guid:"211c246d-9971-4b8d-83fc-5fd6d1dc9194";op:Multiply;lbl:"Outline Width";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,sp(name:"Outline Color Vertex";imps:list[imp_mp_color(def:RGBA(0, 0, 0, 1);hdr:False;cc:4;chan:"RGBA";prop:"_OutlineColorVertex";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"3c8556ae-dc3c-4d67-b2f5-f653da9e9aa6";op:Multiply;lbl:"Color";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1),imp_ct(lct:"_BaseMap";cc:4;chan:"RGBA";avchan:"RGBA";guid:"ae083712-abd0-4384-b3d2-04a5d2dc3057";op:Multiply;lbl:"Outline Color Vertex";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[ct(cimp:imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:4;chan:"RGBA";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_BaseMap";md:"";gbv:False;custom:True;refs:"";pnlock:False;guid:"196ff422-46ca-4f53-8867-d455baa75a8e";op:Multiply;lbl:"Main Texture";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1);exp:True;uv_exp:False;imp_lbl:"Texture")];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 55a58679b47a6f631e61dbab585a8e11 */
